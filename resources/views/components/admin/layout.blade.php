<div class="drawer lg:drawer-open">
  ...
  <div class="drawer-content">
    ...
    <nav class="navbar w-full bg-base-300">
      ...
      <div class="px-4 font-medium">Whim</div>
      <div class="px-4 font-medium ml-auto">ADMIN</div>
    </nav>
  ...
  <aside class="drawer-side is-drawer-close:overflow-visible">
    ...
    <div class="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64">
      ...
      <ul class="menu w-full grow">
        ...
        <!-- List item -->
        <li>
          <a href="{{ route('admin.whims') }}" class="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Whims">
            <!-- Whims icon -->
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-linejoin="round" stroke-linecap="round"
              stroke-width="2" fill="none" stroke="currentColor" class="my-1.5 inline-block size-4">
            ...
            <span class="is-drawer-close:hidden">Whims</span>
          </a>
        </li>
